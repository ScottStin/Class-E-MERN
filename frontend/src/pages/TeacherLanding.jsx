...
export class TeacherLanding extends Component {
    constructor(props){
        super(props);
    ...
    teacherPic = function(currentLesson,currentPageTeacher,currentPageStudent,currentPageTeacherMyClasses){
  ...
  render() {
    ...
    return(
      ...
      //       <LessonCard item={item} currentPageTeacher={this.props.currentPageTeacher} currentPageStudent={this.props.currentPageStudent} currentPageTeacherMyClasses={this.props.currentPageTeacherMyClasses} /> 
      //   ))}
      // </div>
  ...
  {this.state.lessons.sort((a, b) => a.lessonStartDate > b.lessonStartDate ? 1 : -1).map((item)=>( 
            <div>
                {(()=>{
                    ...
                    if(item.lessonType == localStorage.getItem("ClassFilter")&&localStorage.getItem("ClassFilter")=="General English"){

                      if(JSON.parse(localStorage.getItem("CurrentStudent"))&&JSON.parse(localStorage.getItem("CurrentStudent")).studentLevel){      
                        if(item.lessonLevel==JSON.parse(localStorage.getItem("CurrentStudent")).studentLevel){                  
                          return(
                            <LessonCard item={item} currentPageTeacher={this.props.currentPageTeacher} currentPageStudent={this.props.currentPageStudent} currentPageTeacherMyClasses={this.props.currentPageTeacherMyClasses} />               
                          )
                        }
                    ...
                    } else if(item.lessonType == localStorage.getItem("ClassFilter")){
                      return(
                        <LessonCard item={item} currentPageTeacher={this.props.currentPageTeacher} currentPageStudent={this.props.currentPageStudent} currentPageTeacherMyClasses={this.props.currentPageTeacherMyClasses} />               
                      )
                    }
